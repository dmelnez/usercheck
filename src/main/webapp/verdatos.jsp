...
try {  //AQUI VA EL CONTROL DE SESION
	String acceso = session.getAttribute("attributo1").toString();  // Creacion de una variable llamada "acceso", de tipo texto. El cual contiene el valor del metodo "getAttribute".
 	if (!acceso.equals("1")) response.sendRedirect("cerrarsesion.jsp"); // Si el valor de acceso, es distinto de "1", envia al usuario a la pagina "cerrarsesion.jsp".
} catch (Exception e) {
